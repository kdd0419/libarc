...
def char_upgrade(character, rlt_print=False):
    ...
    if (auth_str and ('Authorization' not in headers)):
        headers['Authorization'] = auth_str
    char_upgrade_url = 'https://arcapi.lowiro.com/6/user/me/character/' + \
        str(character) + '/exp'
...
def char_awaken(character, rlt_print=False):
    ...
    if (auth_str and ('Authorization' not in headers)):
        headers['Authorization'] = auth_str
    char_awaken_url = 'https://arcapi.lowiro.com/6/user/me/character/' + \
        str(character) + '/uncap'
...
def friend_add(friend_code, rlt_print=False):
    ...
    if (auth_str and ('Authorization' not in headers)):
        headers['Authorization'] = auth_str
    friend_add_url = 'https://arcapi.lowiro.com/6/friend/me/add'
    #
...
def friend_del(friend_id, rlt_print=False):
    ...
    if (auth_str and ('Authorization' not in headers)):
        headers['Authorization'] = auth_str
    friend_del_url = 'https://arcapi.lowiro.com/6/friend/me/delete'
...
def frag_friend_slot(rlt_print=False):
    ...
    if (auth_str and ('Authorization' not in headers)):
        headers['Authorization'] = auth_str
    friend_slot_url = 'https://arcapi.lowiro.com/6/purchase/me/friend/fragment'
...
def frag_stamina(rlt_print=False):
    ...
    if (auth_str and ('Authorization' not in headers)):
        headers['Authorization'] = auth_str
    stamina_url = 'https://arcapi.lowiro.com/6/purchase/me/stamina/fragment'
...
def get_character_info(rlt_print=False):
    ...
    if (auth_str and ('Authorization' not in headers)):
        headers['Authorization'] = auth_str
    get_character_info_url = 'https://arcapi.lowiro.com/6/user/me/character'
...
def get_score_token(rlt_print=False):
    ...
    if (auth_str and ('Authorization' not in headers)):
        headers['Authorization'] = auth_str
    get_score_token_url = 'https://arcapi.lowiro.com/6/score/token'
...
def get_world_map(rlt_print=False):
    ...
    if (auth_str and ('Authorization' not in headers)):
        headers['Authorization'] = auth_str
    get_world_map_url = 'https://arcapi.lowiro.com/6/world/map/me'
...
def get_world_token(
    ...
    if (auth_str and ('Authorization' not in headers)):
        headers['Authorization'] = auth_str
    world_token_url = 'https://arcapi.lowiro.com/6/score/token/world'
...
def post_score(
    ...
    if (auth_str and ('Authorization' not in headers)):
        headers['Authorization'] = auth_str
    post_score_url = 'https://arcapi.lowiro.com/6/score/song'
...
def rank_friend(song_id, difficulty, start, limit, rlt_print=False):
    ...
    if (auth_str and ('Authorization' not in headers)):
        headers['Authorization'] = auth_str
    rank_friend_url = 'https://arcapi.lowiro.com/6/score/song/friend'
...
def rank_me(song_id, difficulty, start, limit, rlt_print=False):
    ...
    if (auth_str and ('Authorization' not in headers)):
        headers['Authorization'] = auth_str
    rank_me_url = 'https://arcapi.lowiro.com/6/score/song/me'
...
def rank_world(song_id, difficulty, start, limit, rlt_print=False):
    ...
    if (auth_str and ('Authorization' not in headers)):
        headers['Authorization'] = auth_str
    rank_world_url = 'https://arcapi.lowiro.com/6/score/song'
...
def set_character(character, skill_sealed=False, rlt_print=False):
    ...
    if (auth_str and ('Authorization' not in headers)):
        headers['Authorization'] = auth_str
    set_character_url = 'https://arcapi.lowiro.com/6/user/me/character'
...
def set_map(map_id, rlt_print=False):
    ...
    if (auth_str and ('Authorization' not in headers)):
        headers['Authorization'] = auth_str
    set_map_url = 'https://arcapi.lowiro.com/6/world/map/me/'
    #
...
def user_info(rlt_print=False):
    ...
    user_info_url = 'https://arcapi.lowiro.com/6/compose/aggregate'
...
def user_login(
    ...
    login_url = 'https://arcapi.lowiro.com/6/auth/login'
...
def user_register(
    ...
    register_url = 'https://arcapi.lowiro.com/6/user/'
